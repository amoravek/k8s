...
EXPIRATION_SECS=315360000 # 10 years
...
kubectl create -f manifests/resource-quota.yaml -n ${KUBE_NS} --dry-run=client -o yaml | kubectl apply -f -
kubectl create -f manifests/limit-range.yaml -n ${KUBE_NS} --dry-run=client -o yaml | kubectl apply -f -
